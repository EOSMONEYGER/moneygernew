...
public class InfoFragment extends Fragment {
    ...
    public ArrayList<InfoData> getInfoList() {
        if (infoList.size() == 0) {
            infoList.add(new InfoData("10.1", "rji3o2", R.drawable.icon_settings));
            infoList.add(new InfoData("10.2", "ewi2", R.drawable.icon_settings));
            infoList.add(new InfoData("10.3", "rjqegqgo2", R.drawable.icon_settings));
        }
